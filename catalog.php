  ...
  <body>
    ...
    <!-- PRODUCT SHOWCASE -->
        <?php 
            ...
            $sql=mysqli_query($GLOBALS['koneksi'],"SELECT * FROM mainproduct where jenis='sepeda' ORDER BY id_barang DESC");
    ...
    <div class="row">
        <div class="col ml-3 pb-3">
            ...
            <?php do{ ?>
                <a href="filter.php?filter=<?=$row1['brand']?>" class="btn btn-outline-primary ml-3" id="polygon"><?php echo $row1['brand']?></a>
    ...
    <div id="container"> 
        ...
        <?php do{ ?>
            ...
            <div class="card text-center" style="width: 18rem;">
                ...
                <img src="adminKT/upload/<?php echo $row['img_barang'];?>" class="card-img-top" alt="..." style="width: 240px; height: 160px;">
                <div class="card-body">
