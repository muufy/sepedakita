    ...
    <div class="row mr-0" id="body-row">
        <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
            <ul class="list-group">
                ...
                <a href="" class=" list-group-item list-group-item-action flex-column align-items-start" id="option">
                    <div class="d-flex w-100 justify-content-start align-items-center">
        ...
        <!-- START FORM -->
			<div class="row justify-content-center">
				<div class="col-md-8 bg-abu">
					<form method="post" action="authAddAdmin.php" enctype="multipart/form-data" >
					    ...
					    <?php }?>
						<h3 class="display-5 pb-3 pt-5">Add Admin</h3>
						 <div class="form-group">
						   <label>Fullname :</label>
						   <input required autocomplete="off" maxlength="26"  type="text" class="form-control" name="fullname">
                        </div>

                        <div class="form-group">
						    <label>Username :</label>
						    <input required autocomplete="off" maxlength="12" type="text" class="form-control" name="username">
						</div>

						<div class="form-group">
						    <label>Password :</label>
						    <input required autocomplete="off" maxlength="50" type="password" class="form-control" name="password">
						</div>

                        <div class="p-3">
						<input required type="submit" class="btn btn-primary pl-2" name="addadmin" value="Input"></input></div>
					</form>	
				</div>
			</div>
			<!-- END FORM -->
