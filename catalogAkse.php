  ...
  <body>
    ...
    <!-- PRODUCT SHOWCASE -->
        <?php 
            ...
            $sql=mysqli_query($GLOBALS['koneksi'],"SELECT * FROM mainproduct where jenis='aksesoris' ORDER BY id_barang DESC");
    ...
    <div class="row">
        <div class="col ml-3 pb-3">
            ...
            <?php do{ ?>
                <a href="filter.php?filterakse=<?=$row1['brand']?>" class="btn btn-outline-primary ml-3"><?php echo $row1['brand']?></a>
